<div x-data="{ input_fields: @entangle('input_fields'),upload_fields: @entangle('upload_fields'), }">
    <form action="{{ url('settings/address/import_barangays')}}" method="POST" enctype="multipart/form-data" x-show.transition.duration.200ms="upload_fields">
        <div class="input-group m-1" >
            @csrf
            <div class="custom-file">
                <input type="file" name="rpt_excell" class="custom-file-input" id="exampleInputFile">
                <label class="custom-file-label" for="exampleInputFile">Choose file</label>
            </div>
            <div class="input-group-append">
                <button type="submit" class="input-group-text btn-primary" >Upload</button>
            </div>
        </div>
    </form>
    <div class="card">
        <div class="card-header bg-primary">
            <h2 class="card-title card-sm">BARANGAY</h2>
            <div class="card-tools">
                <button x-on:click="upload_fields = !upload_fields" type="button" class="btn btn-secondary btn-sm">
            ...
            <table class="table table-hover text-nowrap table-sm table-striped">
                ...
                <tbody>
                    <tr x-show.transition.duration.200ms="input_fields">
                        ...
                        <td>
                            <input wire:model.defer="new_index" style="width:200px"
                            style="text-transform:uppercase" type="text" class="form-control">
                        </td>
                        <td>
                            <input wire:model.defer="new_name" style="width:200px"
                            style="text-transform:uppercase" type="text" class="form-control">
                        </td>
                    </tr>
